...
function generateLlmsTxt () {
  const parts = [
    ...
    '      -- video("vid") is the video\'s game (session 1; hosts pass their',
    '      -- current session); local files: video("game.json"),',
    '      -- folder("dir") / folder("dir", false) for *.json under a dir',
